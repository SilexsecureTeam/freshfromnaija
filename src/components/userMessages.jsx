...
export default function MessagePageBody() {
    ...
    return (
        ...
        {/* 
          On desktop (md+): show both panes in flex.
          On mobile: only show "aside" if selectedId is null; otherwise only show chat.
        */}
        <div className="min-h-screen md:flex">
          ...
          <aside
            className={`
              ...
              ${selectedId !== null ? 'hidden' : 'block'}   /* hide on mobile when a chat is open */
          ...
          >
            <div className="p-4">
              ...
              <div className="flex mt-2 text-sm text-gray-600">
                Sort by{' '}
                <select className="text-green-600 font-medium ml-1">
              ...
              {contacts.map((c) => (
                <li
                  ...
                  className={`
                    ...
                    ${c.id === selectedId ? 'bg-green-50' : 'hover:bg-gray-100'}
                  `}
                >
                  <img
                    src={c.avatar}
          ...
          <main
            className={`
              flex-1 flex flex-col bg-white shadow rounded-[10px]
              ${selectedId === null ? 'hidden' : 'block'}  /* hide on mobile unless a chat is open */
              md:block   /* always show on md+ */
              mt-4 md:mt-0
            `}
          >
            ...
            <div
              ref={listRef}
              className="flex-1 overflow-auto px-6 py-4 space-y-4 bg-gray-50"
            >
              {currentMessages.map((m, i) => (
                <div
                  key={i}
                  className={`
                    max-w-lg p-3 rounded-lg shadow
                    ${m.fromMe
