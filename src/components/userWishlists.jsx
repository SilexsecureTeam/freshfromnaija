            ...
            <div className="flex justify-between items-center mb-8 mt-10">
                ...
                <div className="relative">
                    <input
                        type="text"
                        placeholder="Search…"
                        className="!border border-[#3333334D] bg-[#F6F6F6] rounded-[6px] text-[#8B909A] pl-4 pr-10 py-2 focus:outline-none"
                    />
                    <svg
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {paged.map(item => (
                    ...
                    >
                        ...
                        <div className="bg-[#F7F5F7] p-4 rounded-t-lg flex justify-center">
                            <img
                                src={item.image}
                                alt={item.title}
                        ...
                        <div className="p-4 space-y-2 text-xs text-[#98A2B3]">
                            ...
                            <div className="flex space-x-2 mt-4">
                                <button
                                    ...
                                    className="flex-1 bg-[#009144] text-white rounded-full py-2 text-sm"
                                >
                                    Add To Cart
                                </button>
                                <button
