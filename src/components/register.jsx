    ...
    return (
        <div className='flex justify-between items-center px-4 md:px-20 mt-26 md:mt-40 mb-10'>
            ...
            <div className='text-[#333333] !space-y-6 text-center w-full md:w-[50%] text-[14px] px-0 md:px-10 flex items-center flex-col'>
                <p className='fontPoppins font-semibold text-[24px]'>Get Started Now</p>
                ...
                <button className='bg-[#009144] py-2 w-[90%] md:w-[80%] rounded-[16px] text-white font-semibold'>SignUp</button>
                ...
                <p className='font-semibold text-black'>Have an Account? <Link to='/login'><span className='text-[#009144] font-semibold'>Sign In</span></Link></p>
            </div>
